...
# Sound
pygame.mixer.music.load(r"C:\pygame_vs_code\background.wav")
...
def load(imagename):
    ...
    imagename = "C:\\pygame_vs_code\\gate_imgs\\" + str(imagename) + ".png"
    image = pygame.image.load(imagename)
    image = pygame.transform.scale(image, (30, 30))
    return image

back=pygame.image.load(r"C:\pygame_vs_code\background-pic.jpg")

globe=pygame.image.load(r"C:\pygame_vs_code\pics\globe-pic.png")
globe = pygame.transform.scale(globe, (170, 170))

alice=pygame.image.load(r"C:\pygame_vs_code\pics\alice-pic.png")
alice = pygame.transform.scale(alice, (120, 60))
# Initial alpha value
a = 250
clock = pygame.time.Clock()

satellite=pygame.image.load(r"C:\pygame_vs_code\pics\satellite-pic.png")
satellite = pygame.transform.scale(satellite, (70, 70))


redsock=pygame.image.load(r"C:\pygame_vs_code\pics\redsock-pic.png")
...
yellowsock=pygame.image.load(r"C:\pygame_vs_code\pics\yellowsock-pic (1).png")
...
sship=pygame.image.load(r"C:\pygame_vs_code\pics\satellite-pic.png")
sship = pygame.transform.scale(sship, (70, 70))

#Game logo
quatum_quest_logo=pygame.image.load(r"C:\pygame_vs_code\pics\satellite-pic.png")
...
while run:
    ...
    if(success==1 and run_button_flag==1):
        print_text1(f"{circuit_chosen} Gate Circuit Building Successful, Great going! :)", 40, 585, (0, 255, 0))
        if(circuit_chosen=="S"):
                ...
                if active_box is not None:
                    ...
                    for i, line_rect in enumerate(lines_rects):
                        ...
                        if boxes1[active_box][1].colliderect(line_rect):
                            ...
                            print(s)
                            if(s==23.2 or s==27.2):         #s-27.2 and x-23.2
                                success=1
                                print("Success", s)
                            break
                active_box = None
    ...
    if len(angle_line_list):
        ...
        print_text_red(f"Time: {time}", 335, 45, (255,0,0))
        print(int(rel_dist), "reldist**")
        dist_travelled=math.sqrt(abs((angle_line_list[-1][0][0]-angle_line_list[-1][1][0])**2-(angle_line_list[-1][0][1]-angle_line_list[-1][1][1])**2))
        if (int(rel_dist)<10 and (bobsock_color==selected_color) and (message_pos not in entangle_points)):
            print(int(rel_dist), "reldist")
            entangle_points.add(message_pos)
            updated_score=float(score[7:])+(dist_travelled/time)
        ...
        if(show==True):
            ...
            print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", rel_dist)
            timer+=1
            while timer >= 10:  # 150 frames = 5 seconds at 30 FPS
                timer=0
                show=False
    print(show, "**")
